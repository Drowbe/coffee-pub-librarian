...
if (!BlacksmithWindowBaseV2) {
    throw new Error('Coffee Pub Librarian | BlacksmithWindowBaseV2 is unavailable for QuestWindow');
}
...
export class QuestWindow extends BlacksmithWindowBaseV2 {
    ...
    static async fromPage(page, options = {}) {
        ...
        try {
            ...
            console.error('Coffee Pub Librarian | Error parsing quest page for edit:', error);
        }
    ...
    async _getActiveObjectiveIndexForWindow() {
        ...
        try {
            ...
            console.error('Coffee Pub Librarian | Error getting active objective for quest window:', error);
        }
        return null;
    }
    ...
    async _updateObject(_event, formData) {
        ...
        try {
            ...
            console.error('Coffee Pub Librarian | Error saving quest:', error);
        ...
        if (dragZone) {
            ...
            const dropHandler = async (event) => {
                ...
                try {
                    ...
                    console.error('Coffee Pub Librarian | Error processing dropped Quest entity:', error);
                }
            };
        ...
        root.querySelectorAll('.quest-item-drop-target').forEach(target => {
            ...
            const dropHandler = async (event) => {
                ...
                try {
                    ...
                    console.error('Coffee Pub Librarian | Error processing treasure drop:', error);
                }
            };
    ...
    async _handleJournalDrop(data) {
        ...
        if (page) {
            try {
                ...
                console.warn('Coffee Pub Librarian | Error parsing dropped journal for Quest entry:', error);
            }
        }
    ...
    async _applyActiveObjectiveSelection(pageUuid, activeObjectiveIndex) {
        ...
        try {
            ...
            console.error('Coffee Pub Librarian | Error saving current objective selection:', error);
        }
    }
    ...
    async _deleteQuest() {
        ...
        try {
            ...
            console.error('Coffee Pub Librarian | Error deleting quest:', error);
