...
export class CodexWindow extends BlacksmithWindowBaseV2 {
    ...
    static DEFAULT_OPTIONS = foundry.utils.mergeObject(
        ...
        {
            id: CODEX_WINDOW_ID,
            classes: ['codex-entry-window', 'codex-window', 'librarian-window'],
    ...
    static async fromPage(page, options = {}) {
        ...
        try {
            ...
            console.error('Coffee Pub Librarian | Error parsing codex page for edit:', error);
        }
    ...
    async _updateObject(_event, formData) {
        ...
        try {
            ...
            console.error('Coffee Pub Librarian | Error saving codex entry:', error);
    ...
    _setupDragAndDrop(root) {
        ...
        const dropHandler = async (event) => {
            ...
            try {
                ...
                console.error('Coffee Pub Librarian | Error processing dropped Codex entity:', error);
            }
        };
    ...
    async _handleJournalDrop(data) {
        ...
        if (page) {
            try {
                ...
                console.warn('Coffee Pub Librarian | Error parsing dropped journal for Codex entry:', error);
