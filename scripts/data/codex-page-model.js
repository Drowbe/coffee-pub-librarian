...
// The subtype string lives in const.js, beside the manifest-mirroring constants,
// and is re-exported here so existing importers keep working. It must agree
// exactly with module.json's documentTypes entry or every page fails validation
// at world load — one source of truth is the point.
export { CODEX_PAGE_TYPE } from '../const.js';
